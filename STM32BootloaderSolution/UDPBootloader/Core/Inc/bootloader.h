...
#define USERAPPLICATION_BASEADDRESS	0x08020000		// Base address of the user application
#define BLRXLEN						100		// buffer size for the bootloader data
...
// This command is used to exit the bootloader when the last packet is received
#define BL_EOT_EXIT				0x45
